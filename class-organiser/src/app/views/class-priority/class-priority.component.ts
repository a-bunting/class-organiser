...
@Component({
  selector: 'app-class-priority',
  templateUrl: './class-priority.component.html',
  styleUrls: ['./class-priority.component.scss']
})
export class ClassPriorityComponent implements OnInit {
